      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="mb-16">
          <div className="relative">
            ...
            <div className="absolute left-6 top-0 bottom-0 w-1 bg-gradient-to-b from-[hsl(var(--accent))] to-[hsl(var(--primary))] opacity-60 transform -translate-x-1/2 lg:left-1/2" />
        ...
        >
          ...
          <button className="bg-primary text-primary-foreground px-10 py-4 rounded-xl font-bold text-lg hover:bg-primary/90 transition-all duration-300 shadow-2xl hover:shadow-primary/20 transform hover:scale-105 border-0">
...
function LoyaltyStep({
  ...
  return (
    <li className="relative mb-12 last:mb-0 flex justify-end lg:grid lg:grid-cols-2">
      <div className="absolute left-6 top-6 w-14 h-14 rounded-full bg-gradient-to-br from-[hsl(var(--accent))] to-[hsl(var(--primary))] border-4 border-white shadow-2xl flex items-center justify-center transform -translate-x-1/2 z-10 lg:left-1/2">
      ...
      >
        ...
        >
          <span className="inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-[hsl(var(--accent)/.15)] to-[hsl(var(--primary)/.15)] border border-[hsl(var(--accent)/.3)]">
            {icon}
          </span>
