...
export default function Navbar() {
  ...
  return (
    <>
      {/* Skip link for a11y */}
      <a href="#main" className="sr-only focus:not-sr-only focus:fixed focus:z-[100] focus:top-3 focus:left-3 bg-black text-white px-3 py-2 rounded">
        Skip to content
      </a>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-2">
              <Link
                href="#restaurants"
                onClick={handleAnchor('#restaurants')}
