  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative mx-auto max-w-7xl px-3 sm:px-4 md:px-6">
          <div className="flex items-center justify-between h-14 sm:h-16">
            ...
            <Link href="/" className="flex items-center">
              ...
              <span className="text-lg sm:text-xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-br from-[hsl(var(--foreground))] via-[hsl(var(--primary))] to-[hsl(var(--accent))]">
                Plate
              </span>
            </Link>
            ...
            <nav className="hidden md:flex items-center gap-1">
              {NAV_ITEMS.map((item) => (
                <Link
                  ...
                  className={[
                    "relative px-4 sm:px-5 py-2.5 sm:py-3 text-sm font-semibold rounded-2xl transition-all duration-300 group nav-link",
                    active === item.href
            ...
            <div className="hidden md:flex items-center gap-3 sm:gap-4">
              <Link
                href="/restaurant"
                className="relative inline-flex items-center rounded-2xl border border-border/30 bg-white/50 backdrop-blur-md px-4 sm:px-6 py-2.5 sm:py-3 text-sm font-semibold transition-all duration-300 hover:bg-white/70 hover:border-border/50 hover:shadow-xl hover:shadow-primary/10 hover:scale-105 group overflow-hidden"
              >
              ...
              <a
                ...
                className="relative inline-flex items-center gap-2 rounded-2xl bg-gradient-to-br from-[hsl(var(--primary))] via-[hsl(var(--primary)/.95)] to-[hsl(var(--primary)/.9)] text-[hsl(var(--primary-foreground))] px-4 sm:px-6 py-2.5 sm:py-3 text-sm font-bold shadow-xl shadow-primary/25 hover:shadow-2xl hover:shadow-primary/35 hover:from-[hsl(var(--primary)/.98)] hover:to-[hsl(var(--primary)/.88)] hover:scale-105 transition-all duration-300 group overflow-hidden"
              >
            ...
            <button
              className="md:hidden inline-flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-xl border border-border/40 bg-white/80 backdrop-blur-md hover:bg-white/90 hover:border-border/60 active:scale-95 transition-all duration-200 shadow-lg hover:shadow-xl group menu-button"
        ...
        >
          <div className="mx-auto max-w-7xl px-3 sm:px-4 md:px-6 pb-4 sm:pb-6 pt-2">
            <div className="relative rounded-2xl sm:rounded-3xl border border-border/30 bg-white/85 backdrop-blur-xl p-4 sm:p-6 shadow-2xl shadow-primary/5">
              {/* Subtle gradient overlay for premium feel */}
              <div className="absolute inset-0 rounded-2xl sm:rounded-3xl bg-gradient-to-br from-white/40 to-transparent pointer-events-none" />
              ...
              <nav className="relative flex flex-col space-y-1">
                {NAV_ITEMS.map((item, index) => (
                  <Link
                    ...
                    onClick={handleAnchor(item.href)}
                    className={[
                      "relative px-3 sm:px-4 py-3 sm:py-3.5 rounded-xl text-sm sm:text-base font-medium transition-all duration-200 group overflow-hidden nav-link",
                      active === item.href
              ...
              <div className="mt-4 sm:mt-6 pt-4 sm:pt-6 border-t border-border/20 flex flex-col gap-3">
                <Link
                  href="/restaurant"
                  className="relative inline-flex items-center justify-center rounded-2xl border border-border/40 bg-white/40 px-4 sm:px-6 py-3 sm:py-3.5 text-sm font-semibold transition-all duration-200 hover:bg-white/60 hover:border-border/60 hover:shadow-lg active:scale-[0.98] group overflow-hidden"
                >
