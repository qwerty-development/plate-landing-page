        ...
        <div className="mx-auto max-w-7xl px-6 py-12 lg:py-16">
          <div className="rounded-2xl border border-border/70 bg-white/60 backdrop-blur p-6 lg:p-8 shadow-sm">
            <div className="grid lg:grid-cols-[1fr_auto] items-center gap-6">
              <div>
                <p className="text-xs uppercase tracking-[0.18em] text-muted-foreground">Ready to try Plate?</p>
                <h3 className="mt-2 text-2xl lg:text-3xl font-semibold">More bookings. Fewer gaps. Happier guests.</h3>
        ...
        <div className="mx-auto max-w-7xl px-6 py-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <p className="text-sm text-muted-foreground text-center sm:text-left">
              © {new Date().getFullYear()} <span className="font-medium">QWERTY</span>. Built by{" "}
            ...
            <div className="flex items-center gap-5 text-sm">
              ...
              <Link href="#" className="text-muted-foreground hover:text-foreground transition">For Restaurants</Link>
              <a
